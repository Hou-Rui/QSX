...
public:
    ...
    {
        SetRunParametersDialog->setWindowTitle(QApplication::translate("SetRunParametersDialog", "Set Run Parameters", nullptr));
        label->setText(QApplication::translate("SetRunParametersDialog", "Address or label to start running program", nullptr));
        label_2->setText(QApplication::translate("SetRunParametersDialog", "Command-line arguments to pass to program", nullptr));
    } // retranslateUi
